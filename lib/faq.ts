...
export const faqGroups: FaqGroup[] = [
  {
    ...
    items: [
      {
        question: "What is unboxyourtax?",
        answer:
          "unboxyourtax is a private question-answering tool for your own PDFs. Upload insurance policies, leases, tax forms, medical statements, or contracts, then ask in plain English. Answers come from your files — with a page number and the exact quoted passage — not from generic internet knowledge. If the answer isn’t in what you uploaded, unboxyourtax says so instead of guessing.",
      },
      {
        question: "Is unboxyourtax free?",
        answer:
    ...
    items: [
      {
        ...
        answer:
          "PDF files only, and they must contain selectable text. unboxyourtax reads the words on each page to build a private search index. Scanned images, photos of documents, and handwritten PDFs are not supported yet.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "The most common reason is that the PDF is a scan without selectable text — unboxyourtax cannot read it yet. Other failures include non-PDF files, files over 25 MB, or a PDF with no readable pages. The document list shows an error message when processing fails.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Open Documents and use the delete control on that file. unboxyourtax immediately removes the encrypted file and every indexed excerpt created from it. Deleted documents cannot be queried afterwards.",
      },
    ],
  },
  {
    ...
    items: [
      {
        question: "How does unboxyourtax come up with answers?",
        answer:
          "When you ask a question, unboxyourtax searches the private index of your documents for the most relevant passages. A language model then answers using only those excerpts. It is instructed not to use outside knowledge or fill in gaps. Every claim should be tied to a citation you can open and check.",
      },
      {
      ...
      {
        question: "What if unboxyourtax can’t find the answer?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Yes. Chat keeps recent turns in the conversation, so you can ask “what about flood damage?” after a deductible question. Follow-ups still have to be grounded in retrieved excerpts; unboxyourtax will not invent a clause to keep the conversation going.",
      },
      {
        question: "Does unboxyourtax search all of my files at once?",
        answer:
          "Yes. A question searches every ready document in your account. If you have both a lease and an insurance policy uploaded, unboxyourtax can pull from either, and citations show which file a quote came from.",
      },
    ],
  },
  {
    ...
    items: [
      {
        question: "Can unboxyourtax help with UK tax documents?",
        answer:
          "Yes. If you upload a tax PDF — for example a P60, Self Assessment form, or accountant letter — and ask a tax-related question, unboxyourtax searches your file and official UK guidance together. Answers distinguish what your document says from what current HMRC/GOV.UK guidance says, and cite both.",
      },
      {
        question: "Where does the UK tax guidance come from?",
        answer:
          "From official GOV.UK pages only — such as Income Tax rates, National Insurance, VAT, Capital Gains Tax, dividends, savings, Self Assessment, and HMRC employer threshold guides. unboxyourtax does not use tax blogs, forums, or the model’s memorised training data for rates.",
      },
      {
      ...
      {
        question: "Is unboxyourtax a tax adviser or accountant?",
        answer:
          "No. Tax answers are informational only. unboxyourtax will not tell you what you should file, claim, or pay. For a filing or a personal tax position, speak to a qualified adviser or HMRC.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "Only you, while you are signed in to your account. Files are not given public URLs, and there is no sharing. Other unboxyourtax users cannot search your documents.",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        question: "Is unboxyourtax legal, financial, or medical advice?",
        answer:
      ...
      {
        question: "What can’t unboxyourtax do yet?",
        answer:
      ...
      },
      {
        ...
        answer:
          "While you are signed in, use Sign out in the app header. You will return to the unboxyourtax home page and need to log in again to see your documents.",
      },
    ],
  },
];
...
const featuredQuestions = new Set([
  "What is unboxyourtax?",
  "What file types can I upload?",
  "What if unboxyourtax can’t find the answer?",
  "Who can see my documents?",
  "Is unboxyourtax legal, financial, or medical advice?",
]);
